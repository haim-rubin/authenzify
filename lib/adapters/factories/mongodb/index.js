...
const MongoPermissionsGroupsService_1 = require("./MongoPermissionsGroupsService");
...
const initMongoDalServices = async ({ config, }) => {
    ...
    const iDalPermissionsGroupsService = new MongoPermissionsGroupsService_1.MongoPermissionsGroupsService(modelsCollections);
    return {
        iDalUsersService,
