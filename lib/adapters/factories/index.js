...
const factory = async (configService) => {
    ...
    const { iDalUsersService, iDalVerificationsService, iDalPermissionsService } = await (0, mongodb_1.initMongoDalServices)({
    ...
    const Permissions = new Permissions_service_1.PermissionsService(configService, iDalPermissionsService);
