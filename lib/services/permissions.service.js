...
class PermissionsService {
    constructor(config, iDalPermissionsService) {
    ...
    async findPermissionsGroups({ tenantId, filter, }) {
        const permission = await __classPrivateFieldGet(this, _PermissionsService_iDalPermissionsGroupsService, "f").findGroups({
            filter,
            tenantId,
        });
        return permission ? (0, mongodb_util_1.mapMongoDbId)(permission) : permission;
    }
