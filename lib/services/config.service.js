...
class ConfigService {
    ...
    get approvePermissionsByPermissionsName() {
        return (__classPrivateFieldGet(this, _ConfigService_config, "f").approvePermissionsByPermissionsName ||
            'allow-approve-users-permissions');
    }
    get signInRoute() {
        return __classPrivateFieldGet(this, _ConfigService_config, "f").signInRoute;
    }
    get logger() {
        return __classPrivateFieldGet(this, _ConfigService_config, "f").logger === !!__classPrivateFieldGet(this, _ConfigService_config, "f").logger
            ? __classPrivateFieldGet(this, _ConfigService_config, "f").logger
            : true;
    }
    get resetPasswordRoute() {
        return __classPrivateFieldGet(this, _ConfigService_config, "f").resetPasswordRoute;
    }
    get didNotAskedToResetPasswordRoute() {
        return __classPrivateFieldGet(this, _ConfigService_config, "f").didNotAskedToResetPasswordRoute;
    }
    get googleSignInClientId() {
        return __classPrivateFieldGet(this, _ConfigService_config, "f").googleSignInClientId;
    }
    get skipFirstCompanyUserSelectsRoleByEmail() {
        return __classPrivateFieldGet(this, _ConfigService_config, "f").skipFirstCompanyUserSelectsRoleByEmail;
    }
}
