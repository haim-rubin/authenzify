...
class UsersService {
    ...
    async createGoogleUser(userDetails) {
        return __classPrivateFieldGet(this, _UsersService_iDalUsersService, "f").createGoogleUser(userDetails);
    }
    async findOne({ email }) {
        return __classPrivateFieldGet(this, _UsersService_iDalUsersService, "f").findOne({ email });
    }
    async updateUser({ id }, userDetails) {
        return __classPrivateFieldGet(this, _UsersService_iDalUsersService, "f").updateUser({ id }, userDetails);
    }
    async find(filter) {
        return __classPrivateFieldGet(this, _UsersService_iDalUsersService, "f").find(filter);
    }
}
